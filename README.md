...
Drag a .pak file onto the executable or assign it to the tool; pressing Enter or double-clicking will unpack that file along with all other .pak files in the same directory.
